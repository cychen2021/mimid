...
//                (tnt2 != null) && tnt2.getTaint(0).hasTaintType(TaintType.STRLEN)) {
    ...
    public void handleToken(NodeMapper nodeMapper, TokenManager tokenManager, EventSender eventSender) {
        ...
        if (Opcode.ICMP == info.getOpcode() && "i32".equals(operand1.getType()) && "i32".equals(operand2.getType())) {
            ...
            eventSender.tokenCompare(operand1.getValue(),
                    operand2.getValue(),
                    null != tnt1 ? tnt1.getTaint(0) : null,
                    null != tnt2 ? tnt2.getTaint(0) : null, tokenManager);
        } else {
    ...
    private void tokenManagerUpdate(NodeMapper nodeMapper, TokenManager tokenManager) {
        ...
        if (null != tnt1 && !tnt1.isEmpty() && !tnt1.getTaint(0).hasTaintType(TaintType.TOKEN)) {
            ...
            if (null != tnt2 && !tnt2.isEmpty() && !tnt2.getTaint(0).hasTaintType(TaintType.TOKEN)) {
