...
public interface OperationFactory {
    ...
    /**
     * Creates a strdup operation with the given line information.
     * @param info
     * @return
     */
    Operation strdup(LineInformation info);
    ...
    /**
     * Creates an operation that handles the strtok function.
     * @param info
     * @return
     */
    Operation strtok(LineInformation info);

    /**
     * Creates an operation that handles the strstr function.
     * @param info
     * @return
     */
    Operation strstr(LineInformation info);

    /**
     * Creates an operation that handles the change or creation of a filedescriptor (FD). FD's might be reused or duplications might be created which makes the distinction of sources impossible.
     * @param info
     * @return
     */
    Operation fileDescriptorBinding(LineInformation info);

    /**
     * Creates an operation that handles a call to vsnprintf.
     * @param info
     * @return
     */
    Operation vsnPrintf(LineInformation info);

    /**
     * Creates a Cmimid operation to print out cmimid specific information.
     * @param info
     * @return
     */
    Operation cmimid(LineInformation info);

    /**
     * Creates an isX operation handling calls to isupper, islower, isalpha, isdigit, isxdigit, isspace, isprint,
     * isgraph, isblank, iscntrl, ispunct, isalnum
     * @param info
     * @return
     */
    Operation isX(LineInformation info);

    /**
     * Creates an ungetc operation.
     * @param info
     * @return
     */
    Operation ungetc(LineInformation info);
