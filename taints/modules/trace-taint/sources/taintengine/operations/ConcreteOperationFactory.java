...
public class ConcreteOperationFactory implements OperationFactory {
    ...
    public Operation call(LineInformation info) {
        ...
        if (instruction.contains("@toupper(") || instruction.contains("@tolower(")) {
            return new GenericOperation(info);
        }
        if (instruction.contains("@__assert_rtn")) {
            return new Assert(info);
        }
        if (instruction.contains("@__strlcpy_chk")) {
            return new StrNCopy(info);
        }
    ...
    @Override
    public Operation strdup(LineInformation info) {
        return new StrDup(info);
    }
    ...
    @Override
    public Operation strtok(LineInformation info) {
        return new StrToK(info);
    }

    @Override
    public Operation strstr(LineInformation info) {
        return new StrStr(info);
    }

    @Override
    public Operation fileDescriptorBinding(LineInformation info) {
        return new FileDescriptorBinding(info);
    }

    @Override
    public Operation vsnPrintf(LineInformation info) {
        return new VsnPrintf(info);
    }

    @Override
    public Operation cmimid(LineInformation info) {
        return new Cmimid(info);
    }

    @Override
    public Operation isX(LineInformation info) {
        return new IsX(info);
    }

    @Override
    public Operation ungetc(LineInformation info) {
        return new UngetC(info);
    }
    ...
    public Operation getOperation(LineInformation info) {
        ...
        case FDBINDING:
            return fileDescriptorBinding(info);

        case VSNPRINTF:
            return vsnPrintf(info);
