...
public class InsertValue extends ValueOperation {
     ...
     * @param info the line information used by this instruction
     */
...
//        String structName;
//        String fieldName = EQUALPATTERNCONSTANT.split(info.getAssignedRegisterType())[0].replace("%struct.", "");
//        String accessedStructure = EQUALPATTERNCONSTANT.split(info.getAssignedRegisterType())[0].replace("%struct.", "");
//
